    ...
    public SwipeToLoadLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            for (int i = 0; i < N; i++) {
                ...
                } else if (attr == R.styleable.SwipeToLoadLayout_header_id) {
                    setHeaderId(a.getResourceId(R.styleable.SwipeToLoadLayout_header_id, 0));
                } else if (attr == R.styleable.SwipeToLoadLayout_footer_id) {
                    setHeaderId(a.getResourceId(R.styleable.SwipeToLoadLayout_footer_id, 0));
                } else if (attr == R.styleable.SwipeToLoadLayout_target_id) {
                    setHeaderId(a.getResourceId(R.styleable.SwipeToLoadLayout_target_id, 0));
                }
            }
        } finally {
            a.recycle();
